...
## 2024-05-19 - Inline Delete Confirmations
**Learning:** Destructive actions like deleting items often trigger jarring modal dialogs or happen too quickly, leading to accidental data loss. Replacing a standard delete button with an inline "Sure?" confirmation state (with a timeout) improves UX by preventing accidents while maintaining context and flow without modal interruption.
**Action:** Prefer inline confirmation states for destructive UI actions within lists over immediate execution or full modal dialogs, and ensure proper focus visibility and timeout cleanup are maintained.
