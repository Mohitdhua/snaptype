...
## 2024-05-18 - Destructive Action Inline Confirmations
**Learning:** Destructive actions like deleting items often lack confirmation, leading to accidental data loss. Full modal dialogs for these actions can feel heavy and disrupt flow in list views.
**Action:** Implement inline timed confirmations (e.g., transforming the delete button to a "Sure?" prompt with a 3-second timeout) for item-level destructive actions. It provides safety without breaking context.
