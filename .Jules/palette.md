...
## 2023-10-27 - Inline Delete Confirmation
**Learning:** Implementing inline confirmation states (like transforming a delete button into a 'Sure?' prompt) avoids jarring modal interruptions and keeps the user focused, while still preventing accidental destructive actions.
**Action:** Prefer inline multi-stage clicks with timeouts for item-level destructive actions in lists or tables, utilizing useRef for timeouts and updating standard focus ring states for accessibility.
