                    ...
                    <div className="p-3 bg-white/5 border-t border-white/10 flex gap-2 justify-between">
                         <div className="flex gap-2 w-full">
                            ...
                            <button 
                                ...
                                className={`rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark ${confirmDeleteId === test.id ? 'bg-red-500/20 text-red-400 font-bold px-3 text-xs' : 'p-2 text-stitch-muted hover:text-red-400 hover:bg-red-500/10'}`}
                                aria-label={confirmDeleteId === test.id ? "Sure? Confirm delete" : "Delete Test"}
