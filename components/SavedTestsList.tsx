                    ...
                    <div className="p-3 bg-white/5 border-t border-white/10 flex gap-2 justify-between">
                         <div className="flex gap-2 w-full">
                            ...
                            <button 
                                ...
                                className={`p-2 rounded-lg transition-colors flex items-center justify-center min-w-[32px] ${
                                  deleteConfirmId === test.id
                                    ? 'bg-red-500 text-white hover:bg-red-600 font-bold text-xs'
                                    : 'text-stitch-muted hover:text-red-400 hover:bg-red-500/10'
                                }`}
                                aria-label={deleteConfirmId === test.id ? "Confirm Delete Test" : "Delete Test"}
                                title={deleteConfirmId === test.id ? "Confirm Delete" : "Delete Test"}
                            >
                                {deleteConfirmId === test.id ? (
                                    <span>Sure?</span>
                                ) : (
