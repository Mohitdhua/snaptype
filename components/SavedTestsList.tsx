                    ...
                    <div className="p-3 bg-white/5 border-t border-white/10 flex gap-2 justify-between">
                         <div className="flex gap-2 w-full">
                            ...
                            <button 
                                ...
                                className={`p-2 transition-colors flex items-center justify-center font-bold text-xs focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark ${
                                  confirmDeleteId === test.id
                                    ? 'bg-red-500 text-white hover:bg-red-600 rounded-lg px-3'
                                    : 'text-stitch-muted hover:text-red-400 hover:bg-red-500/10 rounded-lg'
                                }`}
