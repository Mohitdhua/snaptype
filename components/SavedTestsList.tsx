                    ...
                    <div className="p-3 bg-white/5 border-t border-white/10 flex gap-2 justify-between">
                         <div className="flex gap-2 w-full">
                            ...
                            <button 
                                ...
                                className={`p-2 rounded-lg transition-colors flex items-center justify-center gap-1 ${
                                    confirmDeleteId === test.id
                                      ? 'text-red-400 bg-red-500/20 font-bold text-xs px-3'
                                ...
                                title={confirmDeleteId === test.id ? "Confirm Delete Test" : "Delete Test"}
                            >
                                {confirmDeleteId === test.id ? (
                                    "Sure?"
                                ) : (
