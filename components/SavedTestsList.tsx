                    ...
                    <div className="p-3 bg-white/5 border-t border-white/10 flex gap-2 justify-between">
                         <div className="flex gap-2 w-full">
                            ...
                            <button 
                                ...
                                className={`p-2 rounded-lg transition-colors flex items-center justify-center font-bold text-xs ${
                                    confirmDeleteId === test.id
                                      ? 'bg-red-500/20 text-red-400 border border-red-500/50 min-w-[60px]'
