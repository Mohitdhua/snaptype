                         ...
                         <div className="flex gap-2 w-full">
                            ...
                            {confirmDeleteId === test.id ? (
                                <button
                                    ...
                                    className="px-3 py-2 text-xs font-bold text-white bg-red-500 hover:bg-red-600 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark"
                                ...
                                <button
                                    type="button"
                                    onClick={(e) => handleDeleteClick(e, test.id)}
                                    className="p-2 text-stitch-muted hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark"
