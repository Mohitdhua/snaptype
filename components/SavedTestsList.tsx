                         ...
                         <div className="flex gap-2 w-full">
                            ...
                            <button 
                                ...
                                className={`p-2 rounded-lg transition-colors ${
                                    ...
                                    ? 'bg-red-500/20 text-red-400 hover:bg-red-500/30 px-3 font-bold text-xs flex items-center gap-1'
                                ...
                                title={deleteConfirmId === test.id ? "Confirm Delete Test" : "Delete Test"}
                            >
                                {deleteConfirmId === test.id ? 'Sure?' : (
