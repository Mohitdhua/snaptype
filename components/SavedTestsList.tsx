                         ...
                         <div className="flex gap-2 w-full">
                            ...
                            {confirmingId === test.id ? (
                                <button
                                    ...
                                    className="px-3 py-2 text-xs font-bold text-red-100 bg-red-500/80 hover:bg-red-600 rounded-lg transition-colors flex items-center justify-center min-w-[70px]"
                                ...
                                <button
                                    ...
                                    className="p-2 text-stitch-muted hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors min-w-[36px]"
