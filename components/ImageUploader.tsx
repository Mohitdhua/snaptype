  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center gap-8 animate-fade-in">
      ...
      <div className="w-full relative">
        {inputMode === 'image' ? (
            <div 
                className={`w-full h-80 border-2 border-dashed rounded-[2rem] flex flex-col items-center justify-center relative overflow-hidden transition-all duration-300 ${preview ? 'border-white/20 bg-white/5' : 'border-white/10 hover:border-white/30 bg-transparent'} focus-within:ring-2 focus-within:ring-white/50 focus-within:ring-offset-2 focus-within:ring-offset-stitch-dark`}
            >
                <input
                ref={fileInputRef}
                type="file"
