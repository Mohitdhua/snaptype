                 ...
                 <div className="bento-card p-4 flex flex-col gap-3">
                     ...
                     <div className="flex flex-wrap gap-2">
                         ...
                         <button
                             ...
                             disabled={isSSCMode}
                             className={`px-3 py-2 rounded-xl text-xs font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark flex-1 text-center border ${
