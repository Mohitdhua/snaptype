    ...
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center gap-8 animate-fade-in">
      ...
      <div className="bg-white/5 p-1 rounded-full flex gap-1 border border-white/10">
        <button
            ...
            className={`px-6 py-2 rounded-full text-sm font-medium transition-all focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark ${
                inputMode === 'image' 
                 ...
                 <div className="bento-card p-4 flex flex-col gap-3">
                     ...
                     <div className="flex flex-col gap-2">
                         <button
                             ...
                             className={`p-3 rounded-xl border text-left transition-all focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark ${
                                 gameMode === 'DIGITAL'
                 ...
                 <div className="bento-card p-4 flex flex-col gap-3">
                     ...
                     <div className="flex flex-wrap gap-2">
                         ...
                         <button
                             ...
                             disabled={isSSCMode}
                             className={`px-3 py-2 rounded-xl text-xs font-medium transition-all flex-1 text-center border focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-stitch-dark ${
